...
import "github.com/docker/docker/pkg/generate/fixtures"
...
import (
	github_com_docker_docker_pkg_generate_fixtures "github.com/docker/docker/pkg/generate/fixtures"
)

func(o structWithImports) Copy() structWithImports {
	oCopy := o
	if o.A != nil {
		var oCopy_A github_com_docker_docker_pkg_generate_fixtures.Foo
		oCopy_A = *o.A
		oCopy.A = &oCopy_A
		if o.A.B != nil {
...
func (o structWithImportNeededMap) Copy() structWithImportNeededMap {
	oCopy := o
	if o.A != nil {
		oCopy.A = make(map[string]github_com_docker_docker_pkg_generate_fixtures.Foo, len(o.A))
		for i0, v0 := range o.A {
			oCopy.A[i0] = v0
			if v0.B != nil {
...
func (o structWithImportNeededSlice) Copy() structWithImportNeededSlice {
	oCopy := o
	if o.A != nil {
		oCopy.A = make([]github_com_docker_docker_pkg_generate_fixtures.Foo, len(o.A))
		for i0, v0 := range o.A {
			oCopy.A[i0] = v0
			if v0.B != nil {
				oCopy.A[i0].B = make(map[string]string, len(v0.B))
...
func (o structWithImportedCustomSliceType) Copy() structWithImportedCustomSliceType {
	oCopy := o
	if o.A != nil {
		oCopy.A = make(github_com_docker_docker_pkg_generate_fixtures.StrSlice, len(o.A))
		for i0, v0 := range o.A {
			oCopy.A[i0] = v0
		}
...
func (o structWithImportsAndSimpleFields) Copy() structWithImportsAndSimpleFields {
	oCopy := o
	if o.A != nil {
		var oCopy_A github_com_docker_docker_pkg_generate_fixtures.Quux
		oCopy_A = *o.A
		oCopy.A = &oCopy_A
	}
...
func (o structWithImportsAndUnsettableFields) Copy() structWithImportsAndUnsettableFields {
	oCopy := o
	if o.A != nil {
		var oCopy_A github_com_docker_docker_pkg_generate_fixtures.Banana
		oCopy_A = *o.A
		oCopy.A = &oCopy_A
	}
