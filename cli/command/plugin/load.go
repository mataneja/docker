...
func newLoadCommand(dockerCli *command.DockerCli) *cobra.Command {
	...
	// XXX: quiet for plugins seems unnecessary. Nothing verbose gets printed out anyways.
	// XXX: load needs a --grant-all-permissions flag. The implementation should be similar to
...
func runLoad(dockerCli *command.DockerCli, opts *loadOpts) error {
